...
def check_point_against_ci_band(model, x_new, y_new, se, n, t_value, x_mean, sum_of_squares_x):
    ...
    print(y_new_predicted_mean, lower_ci_new, upper_ci_new)
    ...
    print(lower_ci_new, y_new, upper_ci_new, status)
...
# x_new = 50
# y_new = 0.1
# y_new_predicted_mean, lower_ci_new, upper_ci_new, status = check_point_against_ci_band(model, x_new, y_new, se, n, t_value, x_mean, sum_of_squares_x)
# print(y_new_predicted_mean, lower_ci_new, upper_ci_new, status)
